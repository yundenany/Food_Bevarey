...
public class PopularProductsAdapter extends RecyclerView.Adapter<PopularProductsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(popularProductsModelList.get(adapterPosition).getImg_url()).into(holder.imageView);
        holder.name.setText((popularProductsModelList.get(adapterPosition).getName()));
        holder.price.setText(String.valueOf(popularProductsModelList.get(adapterPosition).getPrice()));
